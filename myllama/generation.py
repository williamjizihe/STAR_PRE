...
from myllama.model import ModelArgs, Transformer
from myllama.tokenizer import ChatFormat, Dialog, Message, Tokenizer
...
class Llama:
    ...
    def build(
        ...
        ckpt_path = checkpoints[0]  # For single-threaded execution, load the first checkpoint
